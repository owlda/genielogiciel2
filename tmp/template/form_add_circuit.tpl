...
<form class="animated zoomInRight" id="AddFormCircuit">
    ...
    <div class="form-group animated zoomInRight" id="ViewNewTheme" style="width: 30%;margin-left: 10%;display: none;">
        ...
        <input type="button" value="{$btn_cancel}" id="btn_not_theme" class="btn btn-secondary" onclick="BtnNotTheme()">
    </div>
    ...
    <input type="button" value="{$btn_cancel}" id="btn_not_theme" class="btn btn-secondary" onclick="location.href='admin.php'">
</form>
