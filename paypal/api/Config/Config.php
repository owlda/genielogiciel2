...
define("PAYPAL_CREDENTIALS", array(
    "sandbox" => [
        "client_id" => "ASPFO2oX5DDjrgbdJ7nz5HSdd7CeZ8fEaLSOVGtRq7qtxgABdh5ReWzZyvpR8z_P4KibogrSem_4hS8x",
        "client_secret" => "ECOHQ_oiPM3Z01B39QNxWmWeogcTYJxO0Yy4PsXUTgwKoqxJrkkFKn1AauFzODe8zGlFfjhhjyvjeXYS"
    ],
    "production" => [
        "client_id" => "",
        "client_secret" => ""
