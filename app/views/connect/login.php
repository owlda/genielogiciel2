<?php require APPROOT . '/views/_layouts/headerApp.php' ?>
    <body>
    <h3 id="allFilms">Connect:</h3>
<form method="POST" style="margin-left: 20%; width: 40%">
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-primary btn-block" id="submitBtn" name="submitLogin">Login</button>
    </div>
</form>
<?php
if (isset($_POST['submitLogin'])) {
    ...
    try {
        ...
        if ($result_connect == true){
            ...
            header("Location: /sandbox/public/connect/error");
            exit();
        }
    }
    catch (Exception $e) {
